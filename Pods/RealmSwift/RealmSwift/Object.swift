...
open class ObjectUtil: NSObject {
    ...
    @objc;; fileprivate;; class func initializeListProperty(_ object: RLMObjectBase, property: RLMProperty, array: RLMArray) {
    ...
    @objc;; fileprivate;; class func initializeLinkingObjectsProperty(_ object: RLMObjectBase, property: RLMProperty) {
        ...
        linkingObjects.attachTo(object, property: property)
    }
}
