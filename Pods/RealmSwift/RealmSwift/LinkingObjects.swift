...
public final class LinkingObjects<T: Object>: LinkingObjectsBase {
    ...
    */
    ...
    public override func value(forKeyPath keyPath: String) -> AnyObject? {
        return rlmResults.value(forKeyPath: keyPath) as AnyObject?
    }
...
open class LinkingObjectsBase: NSObject, NSFastEnumeration {
    ...
    fileprivate;; var object: RLMWeakObjectHandle?
    fileprivate;; var property: RLMProperty?
...
public final class LinkingObjects<T: Object>: LinkingObjectsBase {
    ...
    */
    ...
    public func addNotificationBlock(_ block: ((RealmCollectionChange<LinkingObjects>) -> Void)) -> NotificationToken {
        return rlmResults.addNotificationBlock { results, change, error in
